...
client.on('message', message => {
    ...
    }else if(command == 'bot-links'){
      message.author.send('NIGER')
    }

});
client.on("message", async (message) => {
    const bedword = ["nigga", "n i g g a", "nigger", "n i g g e r", "nigg", "nick gurr", "n i g g", "niggas", "n i g g a s", "niggers", "n i g g e r s", "niggs", "n i g g s", "nig-g-ers", "nig-ers",]
    if (bedword.some(word => message.content.toLocaleLowerCase().includes(word))) {
        message.delete();
        message.reply('**Do not say racial slurs!**')
    }
});
